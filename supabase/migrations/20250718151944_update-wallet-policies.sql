-- Update the view_wallet policy to include REDEEM_WALLET_VOUCHER and CREATE_CHECKOUT_SESSION permissions
...
-- Update the manage_wallet policy to remove REDEEM_WALLET_VOUCHER and CREATE_CHECKOUT_SESSION since they're now in view_wallet
